...
import static com.example.dailytasks.R.id.recyclerviewsuccess;

public class SuccessFragment extends Fragment implements StartDragListener, ItemClickListener {
    ...
    public static SuccessFragment newInstance(int pos, String action, String arg1, String arg2) {
        SuccessFragment SucFrag = new SuccessFragment();
        bundle = new Bundle();
        ...
        SucFrag.setArguments(bundle);
        return SucFrag;
    }

    public static final String TAG = SuccessFragment.class.getSimpleName();

    private SuccessViewModel notificationsViewModel;

    public static void createlistitem() {
        listItems = Paper.book().read("success");
        if (listItems == null) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        notificationsViewModel =
                ViewModelProviders.of(this).get(SuccessViewModel.class);
        View root = inflater.inflate(R.layout.fragment_success, container, false);
        recyclerView = (RecyclerView) root.findViewById(recyclerviewsuccess);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        Paper.book().write("success", listItems);
    }
    ...
    private void DeleteItem(final int pos) throws InterruptedException {
        Thread.sleep(100);
